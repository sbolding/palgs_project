...
A couple strategies could be used.


ASYNCHRONOUSE WOULD BE BETTER. A simple setup to play around with 1D parallelized
code. It can be used in the future to test other algorithmic technqiues without the
overhead of a full MOnte Carlo code.  T
