...
Timing information was performed using built in C functions, such as
\verb{gettimeofday{. We only sample two different problems, but really there is much
    more of the phase space could be sampeled, but this is representative of the two
    approaches.
